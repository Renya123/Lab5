...
$sql_add = "INSERT INTO test SET datez='" . $_GET["datez_n"]
."', id_student='".$_GET["id_student_n"]."', id_subject='"
.$_GET["id_subject_n"]."', ocenka='".$_GET["ocenka_n"].
"'";
mysqli_query($link, $sql_add); // Выполнение запроса
if (mysqli_affected_rows($link)>0) // если нет ошибок при выполнении запроса
{ print "<p>Спасибо, вы зарегистрировали зачет в базе данных.";
