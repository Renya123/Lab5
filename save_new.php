...
$sql_add = "INSERT INTO student SET FIO='" . $_GET["FIO_n"]
."', faculty='".$_GET["faculty_n"]."', gr='"
.$_GET["gr_n"]."', recordcard='".$_GET["recordcard_n"].
"', phone='".$_GET["phone_n"]. "'";
mysqli_query($link, $sql_add); // Выполнение запроса
if (mysqli_affected_rows($link)>0) // если нет ошибок при выполнении запроса
{ print "<p>Спасибо, вы зарегистрировали студента в базе данных.";
