...
$result=mysqli_query($link, "SELECT student_id, FIO, faculty, gr, recordcard, phone FROM student"); // запрос на выборку сведений о студентах
...
$result=mysqli_query($link, "SELECT subject_id, title, FIOT FROM subject"); // запрос на выборку сведений о предметах
...
$result=mysqli_query($link, "SELECT test_id, datez, id_student, id_subject, ocenka FROM test"); // запрос на выборку сведений о зачетах
